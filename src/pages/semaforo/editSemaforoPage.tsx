...
export default function EditSemaforoPage(props:any) {
    ...
    const create = () => {
        let sem = { ...semaforo , relacion: relacionOng };
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            <h2 style={{display:'flex',fontSize:'3rem',marginBottom:'auto'}}>
                <b style={{marginRight:'auto',marginLeft:'auto',textAlign:'center'}}>Editar Red</b>
            </h2>
            <form className={classes.form} noValidate autoComplete="off" >
                ...
                <TextField label="Relaciones con otras ONGs" multiline={true} className={classes.txt} onChange={(event: React.ChangeEvent<HTMLInputElement>) => { setRelacionOng(event.target.value)}} value={relacionOng}/>
